...
# axes[0, 0].legend(loc='upper left', ncols=2)
...
# make two legends
# line2, = axes[0, 0].plot([], [], color=colors[0], label='REML (LRT)')
...
# first_legend = axes[0, 0].legend(handles=[line2, line3, line4], loc='upper left', title='Method')
