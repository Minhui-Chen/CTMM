...
#     op_free_he.loc[op_free_he['CT-specific variance'] < -30, 'CT-specific variance'] = -30
    ...
    # cap at -10 to 10
    ctp_free_he['CT-specific variance'] = ctp_free_he['CT-specific variance'].clip(-20, 20)
    ...
    for ax in axes.flatten():
        ax.set_xlabel('')
        ax.set_ylabel('')
    axes[-1,0].set_xlabel('Main cell type proportion')
    axes[-1,1].set_xlabel('Main cell type proportion')
